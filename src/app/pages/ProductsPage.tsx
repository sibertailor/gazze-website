...
export function ProductsPage() {
  ...
  const categories = [
    ...
    { id: "bags", name: "Kese Kağıdı ve Karton", icon: <ShoppingBag className="w-4 h-4" /> },
    { id: "food", name: "Gıda Ambalajı", icon: <Box className="w-4 h-4" /> },
    { id: "industrial", name: "Ofset Matbaa Kutu", icon: <Layers className="w-4 h-4" /> },
    { id: "wrapping", name: "Pelur (Sarım Kağıdı)", icon: <Truck className="w-4 h-4" /> },
  ...
  const products: Product[] = [
    {
      id: 1,
      category: "bags",
      title: "Lüks Karton Çanta",
      image: "https://images.unsplash.com/photo-1761793126810-58e0cd971057",
    ...
    },
    {
      ...
      category: "bags",
      title: "Doypack",
      image: "/images/kese.jpeg",
      desc: "Yapışkan bantlı, yırtılmaya dayanıklı kraft gönderi torbaları.",
      examples: [
       "https://images.openai.com/static-rsc-3/f6vexSHYfd9nyt61XWymkXU1RH6xuWVn5q61dpbpCtsAkh5nYksyh_6tldxg3svfM4PIv-V3mh7jxgPOnzDWec05GBARd-Uqc831bKLt-GU?purpose=inline",
        "/images/kese-kagidi-2.jpeg",
        "/images/kese-kagidi-3.jpeg",
        "/images/kese-kagidi-4.jpeg",
    ...
    },
    {
      ...
      category: "food",
      title: "Gıda Ambalajı",
      image: "/images/gida.jpeg",
      desc: "Gıda ürünleriniz için güvenli, hijyenik ve kaliteli ambalaj çözümleri.Markanıza özel tasarımlar sayesinde hem ürünlerinizi koruyun hem de müşterilerinizde güçlü bir iz bırakın.",
      examples: [
        "/images/gida-1.jpeg",
        "/images/gida-2.jpeg",
        "/images/gida-3.jpeg",
    ...
    },
    {
      ...
      desc: "Isı korumalı, gıda sertifikalı karton kutular.",
      examples: [
        "/images/pizza-kutusu-11.jpeg",
        "/images/pizza-kutusu-2.jpeg",
      ],
    },
        {
      id: 6,
      category: "food",
      title: "Hamburger Kutusu",
      image: "/images/hamburger.png",
      desc: "Yağ geçirmeyen iç yüzeyli, kilitli gıda kutuları.",
      examples: [
        "/images/hamburger-kutusu-1.jpeg",
        "/images/hamburger-kutusu-2.jpeg",
        "/images/hamburger-kutusu-3.jpeg",
      ],
    },
    {
      id: 4,
      category: "wrapping",
      title: "Pelur Kağıdı",
      image: "/images/pelur-kagidi.jpeg",
    ...
    },
    {
      id: 3,
      category: "industrial",
      title: "Metal Ve Karton Kutu",
      image: "/images/kutu.png",
      desc: "Kaliteli ve lüks tasarımlı kutular.",
      examples: [
        "/images/metal-1.jpeg",
        "/images/metal-2.jpeg",
        "/images/metal-3.jpeg",
